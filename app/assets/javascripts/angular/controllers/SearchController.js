function SearchController($scope, $http, GetGameService){
  ...
  $scope.getGames = function (){
    return $http.get("https://igdbcom-internet-game-database-v1.p.mashape.com/games/?fields=name%2Crating%2Ccover%2Curl%2Csummary%2Cfirst_release_date&limit=50&offset=0&order=release_dates.date%3Adesc&search=" + $scope.search, {"headers": {
